 ...
 *
 * This is used to define all hooks (actions and filters) that are registered
 * with WordPress. When a hook is registered, it is stored in the class
 * and then registered with a call to the run function.
 *
 * @since      2.0.0
 * @package    AS_Laburda_PWA_App
 * @subpackage AS_Laburda_PWA_App/includes
 ...
 */
class AS_Laburda_PWA_App_Loader {
